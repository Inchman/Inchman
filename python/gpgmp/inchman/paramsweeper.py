...
#
#   field
#     This only indicates that the variable is a field variable. It is treated as
#     a single variable.
#
...
def recursive_sweep_params(current_job, remaining_params):
    ...
    if p.domain == 'single' or p.domain == 'field' or not p.domain: # 'single' and if domain not specified
        values = [p.value];
