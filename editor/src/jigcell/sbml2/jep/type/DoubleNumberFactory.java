...
/**
 * Default class for creating number objects. This class can be replaced by other NumberFactory implementations if other number types are
 * required. This can be done using the
 */
